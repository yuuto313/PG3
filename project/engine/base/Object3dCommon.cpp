...
Microsoft::WRL::ComPtr<ID3D12PipelineState> Object3dCommon::CreateGraphicsPipelineState(Microsoft::WRL::ComPtr<ID3D12Device> device, const D3D12_GRAPHICS_PIPELINE_STATE_DESC& desc)
{
